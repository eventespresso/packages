			...
			},
			{
				...
				fields: [
					...
					},
					{
						...
						formControlProps: adjacentFormItemProps,
						info: __(
							'If enabled, a single ticket will be created and assigned to ALL datetimes generated by the recurrence editor and will grant access to ALL of the datetimes.'
						),
					},
				],
			},
