...
import { useTicketMutator, useInitialTPCState } from '@eventespresso/edtr-services';
import { getBasePrice } from '@eventespresso/predicates';
import { calculateBasePrice, useDefaultBasePrice, useMutatePrices } from '@eventespresso/tpc';
...
const useRecalculateBasePrice = (ticketId: EntityId): Callback => {
	...
	const getDataState = useInitialTPCState({ ticketId });
