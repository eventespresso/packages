...
import { Button, Calendar, LabelPosition, TimezoneTimeInfo } from '@eventespresso/components';
  ...
  return (
    <div className={className}>
      ...
      <div className="ee-biggie-calendar-date">
        ...
        {showTime && !timeRange && <div className="ee-bcd__time">{format(dateObject, TIME_ONLY_12H_SHORT_FORMAT)}</div>}
