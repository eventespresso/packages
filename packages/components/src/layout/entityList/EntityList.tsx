...
import { useStatus } from '@eventespresso/services/apollo/status';
...
const EntityList = <E extends Entity, ELFS extends EntityListFilterStateManager<any>>({
  ...
  return (
    <div className={'ee-entity-list'}>
      ...
      <EntityListFilterBar domain={domain} filterState={filterState} legendConfig={legendConfig} listId={listId} />
      {entityList}
      {
