...
import { isFunc } from '@eventespresso/services/utilities/function';
import { isEmpty } from '@eventespresso/services/utilities/array';
import { useMemoStringify } from '@eventespresso/services/hooks';
  ...
  return (
    <div className={wrapperClassName}>
      <Table captionID={captionID} captionText={tableCaption} className={cssClasses.tableClassName} tableId={tableId}>
        <TableHeader className={cssClasses} headerRows={headerRows} showDragHandle={showDragHandle} tableId={tableId} />
        <TableBody
          bodyRows={bodyRows}
