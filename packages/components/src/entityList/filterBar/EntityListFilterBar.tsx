...
import { SearchInput } from '../../../Button/ButtonGroup/node_modules/@application/ui/input';
  ...
  return (
    <div className="ee-filter-bar">
      <div className="ee-filter-bar__main">
        <EntityListViewButtonGroup listId={listId} setCardView={setCardView} setTableView={setTableView} view={view} />
        <ToggleFiltersButton
          listId={listId}
