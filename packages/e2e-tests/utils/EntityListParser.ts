...
export class EntityListParser {
	...
	/**
	 * Rertieve the entity filter bar element.
	 */
	...
	/**
	 * Rertieve the entity items wrapper based on the current view.
	 */
	...
	/**
	 * Rertieve the entity card view list wrapper element.
	 */
	...
	/**
	 * Rertieve the entity table view list wrapper element.
	 */
	...
	/**
	 * Rertieve an array of items in the list.
	 */
	...
	/**
	 * Rertieve an item/element from the entity list.
	...
	/**
	 * Rertieve an item/element from the entity list by the given field value.
	 */
	...
	/**
	 * Rertieve the field value of an item/element.
	 */
	...
	/**
	 * Rertieve the dbId of an item/element. Default to first item.
	 */
	...
	/**
	 * Rertieve the name of an item/element. Default to first item.
	 */
	...
	/**
	 * Rertieve the description of an item/element. Default to first item.
	 */
	...
	/**
	 * Rertieve the dbIds of all the items in the list.
	 */
	...
	/**
	 * Rertieve the number of items in the list.
	 */
	...
	/**
	 * Rertieve the dbId of an item in the list by its name.
	 */
